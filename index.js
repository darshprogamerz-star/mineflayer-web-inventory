  ...
  app.get('/', (req, res) => {
    res.send(`
      ...
      <body>
        <div class="panel">
          <div class="top-bar">
            <div class="title">🤖 Titan Agent + AI Brain</div>
            <div class="badge">Live AI Controller</div>
          </div>
...
if (require.main === module) {
  function launchBot() {
    ...
    bot.once('spawn', () => {
      console.log(`[AGENT JOINED] ${bot.username} entered server with AI Brain.`);
    ...
    // In-game Commands & AI Chat Listener
    bot.on('chat', async (username, message) => {
      ...
      if (fullText.includes('move around') || cmd === 'afk') {
        ...
        // AI Chat Trigger: Jab bhi game me koi bot ka naam ('nokar' ya 'bot') lekar baat karega, Gemini AI reply karega
