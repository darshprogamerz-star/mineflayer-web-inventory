/**
 * Master Autonomous Minecraft Companion & Native Gemini AI
 * Version: 13.0.0-Titan-Native-AI
 */
...
/**
 * Native Gemini AI Function (No external SDK required)
 */
...
async function executeHouseBuild(bot) {
  ...
  if (!getBuildBlock()) return bot.chat("Ghar banane ke liye blocks inventory me nahi hain!");
...
async function runFarmLoop(bot) {
  ...
  const matureCrops = bot.findBlocks({ matching: b => cropIds.includes(b.type) && b.metadata === 7, maxDistance: 32, count: 5 });
      ...
      <body>
        <div class="panel">
          ...
          <div class="ctrl-wrapper">
            <div class="ctrl-title">Manual Movement</div>
            <div class="dpad">
...
if (require.main === module) {
  function launchBot() {
    ...
    bot.once('spawn', () => {
      console.log(`[AGENT JOINED] ${bot.username} entered server with Native AI.`);
