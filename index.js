    ...
    res.send(`
      ...
      <head>
        ...
        <style>
          * { box-sizing: border-box; margin: 0; padding: 0; user-select: none; }
          ...
          .act-btn { padding: 12px; border: none; border-radius: 6px; font-weight: bold; color: white; font-size: 13px; cursor: pointer; transition: 0.1s; }
      ...
      <body>
        <div class="panel">
          ...
          <div class="chat-box">
            <input type="text" id="chatMsg" class="chat-input" placeholder="Chat in game or use command...">
